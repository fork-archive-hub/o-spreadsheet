...
describe("Topbar menus - keyboard shortcuts", () => {
  test("ALT+F to open File menu", async () => {
    const menuDefinitions = Object.assign({}, topbarMenuRegistry.content);
    ...
    await mountParent();
    const menuButton = fixture.querySelector(".o-topbar-menu[data-id='file']");
  ...
  test("ALT+E to open Edit menu", async () => {
    await mountParent();
    const menuButton = fixture.querySelector(".o-topbar-menu[data-id='edit']");
    expect(menuButton!.classList).not.toContain("active");
    expect(fixture.querySelectorAll(".o-menu")).toHaveLength(0);
  ...
  test("ALT+V to open View menu", async () => {
    await mountParent();
    const menuButton = fixture.querySelector(".o-topbar-menu[data-id='view']");
    expect(menuButton!.classList).not.toContain("active");
    expect(fixture.querySelectorAll(".o-menu")).toHaveLength(0);
  ...
  test("ALT+I to open Insert menu", async () => {
    await mountParent();
    const menuButton = fixture.querySelector(".o-topbar-menu[data-id='insert']");
    expect(menuButton!.classList).not.toContain("active");
    expect(fixture.querySelectorAll(".o-menu")).toHaveLength(0);
  ...
  test("ALT+O to open Format menu", async () => {
    await mountParent();
    const menuButton = fixture.querySelector(".o-topbar-menu[data-id='format']");
    expect(menuButton!.classList).not.toContain("active");
    expect(fixture.querySelectorAll(".o-menu")).toHaveLength(0);
  ...
  test("ALT+D to open Data menu", async () => {
    await mountParent();
    const menuButton = fixture.querySelector(".o-topbar-menu[data-id='data']");
    expect(menuButton!.classList).not.toContain("active");
    expect(fixture.querySelectorAll(".o-menu")).toHaveLength(0);
  ...
  test("Menu with all disabled menu items won't break the navigation", async () => {
    ...
    topbarMenuRegistry.addChild("disabledChild", ["disabled"], {
      name: "TestAction",
      sequence: 1,
      execute: () => {},
      isEnabled: () => false,
