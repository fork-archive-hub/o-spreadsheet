...
describe("Model resizer", () => {
  ...
  describe("resize rows when changing font", () => {
    ...
    test("updating column size updates row height with wrapped text", () => {
      ...
      const cell = model.getters.getCell({ sheetId: sheet.id, col: 0, row: 0 })!;
